...
function Rounded(className, sizex, sizey, sizex_b, sizey_b, left_top, right_top, right_bottom, left_bottom){
	var bk;
	...
	if (typeof(left_top) == 'undefined')
		left_top = true;
	if (typeof(right_top) == 'undefined')
		right_top = true;
	if (typeof(right_bottom) == 'undefined')
		right_bottom = true;
	if (typeof(left_bottom) == 'undefined')
		left_bottom = true;
	...
	for (var i = 0; i < l; i++) {
		...
		AddRounded(v[i], bk, color, sizex, sizey, true, left_top, right_top);
		AddRounded(v[i], bk, color, sizex_b, sizey_b, false, left_bottom, right_bottom);
	}
}
...
function AddRounded(el, bk, color, sizex, sizey, top, left, right) {
  if (!sizex && !sizey)
	return;
  var i, j;
  ...
  for (i = 1; i <= sizey; i++) {
    ...
    x.style.margin = "0px ";
	if(left)
       	x.style.marginLeft = n_bg + "px";
    if(right)
       	x.style.marginRight = n_bg + "px";		
	x.style.height='1px';
