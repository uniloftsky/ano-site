...
<logic:notEmpty name="script" property="link"><script type="text/javascript" src="<bean:write name="script" property="link" filter="false"/><logic:match name="script" property="link" value="?">&</logic:match><logic:notMatch name="script" property="link" value="?">?</logic:notMatch><as:random/>"></script></logic:notEmpty>
