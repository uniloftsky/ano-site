 ...
 * @author denis
 */
public class LocalizationsListCMS2Decorator extends LinksListCMS2Decorator{
	...
	static {
		try {
          ...
          Logger.getLogger(LocalizationsListCMS2Decorator.class).fatal("IASSiteDataService  init failure",e);
		}
	}
