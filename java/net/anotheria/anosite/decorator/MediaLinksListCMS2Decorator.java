 ...
 * @author denis
 */
public class MediaLinksListCMS2Decorator extends LinksListCMS2Decorator{
	...
	static {
		try {
          ...
          LoggerFactory.getLogger(MediaLinksListCMS2Decorator.class).error(MarkerFactory.getMarker("FATAL"), "IASSiteDataService  init failure", e);
		}
	}
