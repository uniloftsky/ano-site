...
public class StaticResourceServerNameProcessor implements VariablesProcessor {
     ...
     */
    private static final Logger log = LoggerFactory.getLogger(StaticResourceServerNameProcessor.class);
    ...
    public String replace(String prefix, String variable, String defValue, HttpServletRequest req) {
        if(StringUtils.isEmpty(variable)){
            log.error("StaticResourceServerNameProcessor - replace method: Error! Missing key: " + variable+" in server "+req.getServerName()+" on page: "+req.getRequestURI());
            return null;
        }
