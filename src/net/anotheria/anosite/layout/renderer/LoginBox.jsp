...
<div class="loginform">
  <form method="post" action="<bean:write name="login.action" ignore="true"/>"> 
   ...
   <p><input type="checkbox" id="rememberme" name="rememberme" value="true" class="checkbox" tabindex="3" size="1" /><label for="rememberme" class="right"><bean:write name="res.login.rememberme"/></label></p>
